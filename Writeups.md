...
<!-- WRITEUPS:START -->
- [Victim WhatsApp Android crashes when opening malicious Lottie sticker messages from attacker via…](https://medium.com/@hatimulhusna/victim-whatsapp-android-crashes-when-opening-malicious-lottie-sticker-messages-from-attacker-via-fce8450b2daf?source=rss------bug_bounty_writeup-5)
