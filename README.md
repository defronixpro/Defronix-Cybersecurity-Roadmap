...
### Writeups 📙💯
<!-- WRITEUPS:START -->
- [Vulnyx: Spooisong Write-up — Dari LFI ke Root via Miskonfigurasi DNS](https://medium.com/@blackhuntertf/vulnyx-spooisong-write-up-dari-lfi-ke-root-via-miskonfigurasi-dns-ad3c4ca32afa?source=rss------bug_bounty_writeup-5)
